...
export function IssueCard({
  ...
  const { deleteDatalink } = useVersionIssues({
      ...
      <div role="alertdialog">
        <ConfirmationDialog
          content={{
            ...
            description:
              "Are you sure you want to mark this issue as false detection? This will remove it from the detections list.",
            confirmText: "Confirm",
          ...
          onConfirm={() => {
            ...
            deleteDatalink.mutate(id);
          }}
          isLoading={deleteDatalink.isPending}
        />
      </div>
    </>
  );
